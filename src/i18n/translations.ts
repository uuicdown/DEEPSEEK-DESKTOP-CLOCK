...
export const TRANSLATIONS: Record<Language, Translations> = {
  zh: {
    ...
    rulePeakTitle: '工作日高峰时段（梁文峰 · 原价 100%）：',
    rulePeakDesc: '仅限工作日（周一至周五，法定节假日除外）北京时间 09:00 - 12:00 以及 14:00 - 18:00。并发调用高峰期，按标准费率计费。',
    ruleValleyTitle: '全天与错峰特惠（梁文谷 · 5折 50%）：',
  ...
  en: {
    ...
    rulePeakTitle: 'Workday Peak Hours (Liang Wenpeak · 100% Standard):',
    rulePeakDesc: 'Workdays only (Mon - Fri, excluding statutory holidays) Beijing Time 09:00 - 12:00 & 14:00 - 18:00 (UTC+8). High-concurrency hours billed at standard rates.',
    ruleValleyTitle: 'Weekend & Off-Peak Valley (Liang Wentrough · 50% Off):',
  ...
  ru: {
    ...
    rulePeakTitle: 'Пиковые часы в будние дни (Пиковый Лян · 100%):',
    rulePeakDesc: 'Только в рабочие дни (пн - пт, кроме праздников) по Пекину 09:00 - 12:00 и 14:00 - 18:00 (UTC+8). Стандартный тариф.',
    ruleValleyTitle: 'Выходные, праздники и скидки (Долинный Лян · 50% скидка):',
